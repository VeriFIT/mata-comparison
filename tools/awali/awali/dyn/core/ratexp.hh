...
class ratexp_t : public std::shared_ptr<abstract_ratexp_t> {
 public:
   ...
   *
   * This is the function to create a rational expression over an arbitrary
   * context.
   *
   * @see Documentation of namespace {@link dyn::context}
   */
  static ratexp_t from_context(std::string str, context::labelset_description cd, 
  ...
  */
  struct with_int_labels { 
     ...
     *
     */
    static ratexp_t from_range(std::string str, int l, int u, 
     ...
     *
     */
    static ratexp_t from_size(std::string str,unsigned n, 
                              std::string weightset = "B");
  };
