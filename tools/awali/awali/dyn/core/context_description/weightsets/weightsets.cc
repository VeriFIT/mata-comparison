...
namespace awali {
  namespace dyn {
	...
	if (this->static_public_name() == "B")
	 ...
	 cyclic_weightset 
	 ============================================================================= */
      cyclic_weightset::cyclic_weightset(const std::string& public_name,
					 const std::string& desc) : 
	abstract_weightset(public_name, desc) {}
	...
	return ws;
      ...
      std::string const&
      cyclic_weightset::tostring(weightset_description ws, bool)
	const
      {
	...
	return ws;
      ...
      bool
      cyclic_weightset::is_promotable_to(weightset_description) const {
	return false;
      }
	 ...
	 ============================================================================= */
      ...
      bounded_weightset::bounded_weightset(const std::string& public_name,
					   const std::string& desc) : 
	abstract_weightset(public_name, desc) {}
	...
	return ws;
      ...
      std::string const&
      bounded_weightset::tostring(weightset_description ws, bool)
	const
      {
	static std::string res;
	std::ostringstream o;
	...
	return ws;
      ...
      bool
      bounded_weightset::is_promotable_to(weightset_description) const {
	return false;
      }
