...
class AutomatonEditionTests(unittest.TestCase):
    ...
    def test_03_weightset(self):
        ...
        #self.assertEqual(vr.get_weightset(A).one(), semiring.values[1])
        #self.assertEqual(vr.get_weightset(A).zero(), semiring.values[0])
...
while(semiring.next()):
    sys.stderr.write(
        ...
        "=======================================================================\n"
        +
        "\tEdition tests for automata over weightset " + semiring.name + ".\n"
        +
        "=======================================================================\n"
    );
